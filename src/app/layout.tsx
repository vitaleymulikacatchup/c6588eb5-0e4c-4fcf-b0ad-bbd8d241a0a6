...
export const metadata: Metadata = {
  title: "Bakery Bliss | Freshly Baked Goods",
  description: "Explore our collection of delicious baked goods crafted with love and tradition.",
  openGraph: {
    title: "Bakery Bliss | Freshly Baked Goods",
    description: "Explore our collection of delicious baked goods crafted with love and tradition.",
    siteName: "Bakery Bliss",
    images: [{ url: "https://images.pexels.com/photos/7552324/pexels-photo-7552324.jpeg?auto=compress&cs=tinysrgb&h=650&w=940", alt: "Bakery shop" }],
    type: "website"
  },
  twitter: {
    ...
    title: "Bakery Bliss | Freshly Baked Goods",
    description: "Explore our collection of delicious baked goods crafted with love and tradition.",
    images: ["https://images.pexels.com/photos/7552324/pexels-photo-7552324.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"]
  },
  robots: {
    index: true,
    follow: true
